...
namespace ModAnalyzer.ViewModels
{
    public class AnalysisViewModel : ViewModelBase
    {
        ...
        public ICommand ResetCommand { get { return _resetCommand ?? (_resetCommand = new RelayCommand(() => MessengerInstance.Send(new NavigationMessage(Page.Home)))); } }
        ...
        {
            Application.Current.Dispatcher.BeginInvoke((Action) (() => Log += e.Message + Environment.NewLine));

            if (e.IsStatusMessage)
                Application.Current.Dispatcher.BeginInvoke((Action) (() => ProgressMessage = e.Message.Trim()));
        }
